...
public class CustomTileEntityChest extends TileEntityLockable implements IUpdatePlayerListBox, IInventory
{
    private ItemStack[] chestContents = new ItemStack[27];
    /** Determines if the check for adjacent chests has taken place. */
    public boolean adjacentChestChecked;
    /** Contains the chest tile located adjacent to this one (if any) */
    public CustomTileEntityChest adjacentChestZNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public CustomTileEntityChest adjacentChestXPos;
    /** Contains the chest tile located adjacent to this one (if any) */
    public CustomTileEntityChest adjacentChestXNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public CustomTileEntityChest adjacentChestZPos;
    ...
    public CustomTileEntityChest(int chestType)
    {
    ...
    private void func_174910_a(CustomTileEntityChest p_174910_1_, EnumFacing p_174910_2_)
    {
        ...
        {
            switch (CustomTileEntityChest.SwitchEnumFacing.field_177366_a[p_174910_2_.ordinal()])
            {
                case 1:
    ...
    protected CustomTileEntityChest func_174911_a(EnumFacing p_174911_1_)
    {
        ...
        if (this.func_174912_b(blockpos))
        {
            ...
            if (tileentity instanceof CustomTileEntityChest)
            {
                CustomTileEntityChest tileentitychest = (CustomTileEntityChest)tileentity;
