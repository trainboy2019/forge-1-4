                ...
                for (i3 = -1; i3 <= 1; ++i3)
                {
                    for (j3 = 1; j3 < 3; ++j3)
                    {
                        for (k3 = -1; k3 < 3; ++k3)
                        {
                            ...
                            j4 = k2 + (j3 - 1) * l2 - i3 * l5;
                            boolean flag = k3 < 0;
                            this.worldServerInstance.setBlockState(new BlockPos(l3, i4, j4), flag ? BlockManager.splatoonBlock.getDefaultState() : Blocks.air.getDefaultState());
                        }
                    }
                }
            }
            ...
            for (j3 = 0; j3 < 4; ++j3)
            {
                for (k3 = 0; k3 < 4; ++k3)
                {
                    for (l3 = -1; l3 < 4; ++l3)
                    {
                        ...
                        this.worldServerInstance.setBlockState(new BlockPos(i4, j4, k4), flag1 ? BlockManager.splatoonBlock.getDefaultState() : iblockstate, 2);
                    }
                }
