...
public class CustomComponentScatteredFeature
{
    private static final String __OBFID = "CL_00000473";

    public static void registerScatteredFeaturePieces()
    {
        MapGenStructureIO.registerStructureComponent(CustomComponentScatteredFeature.DesertPyramid.class, "TeDP");
        MapGenStructureIO.registerStructureComponent(CustomComponentScatteredFeature.JunglePyramid.class, "TeJP");
        MapGenStructureIO.registerStructureComponent(CustomComponentScatteredFeature.SwampHut.class, "TeSH");
    }

    public static class DesertPyramid extends CustomComponentScatteredFeature.Feature
        {
            ...
            static
            {
                ChestGenHooks.init(STRONGHOLD_CROSSING, itemsToGenerateInTemple, 2, 7);
                ChestGenHooks.addItem(STRONGHOLD_CROSSING, new WeightedRandomChestContent(new ItemStack(Items.enchanted_book, 1, 0), 1, 1, 1));
            }
            ...
            {
                this.func_175804_a(worldIn, p_74875_3_, 0, -4, 0, this.scatteredFeatureSizeX - 1, 0, this.scatteredFeatureSizeZ - 1, Blocks.red_sandstone.getDefaultState(), Blocks.red_sandstone.getDefaultState(), false);
                int i;

                for (i = 1; i <= 9; ++i)
                {
                    this.func_175804_a(worldIn, p_74875_3_, i, i, i, this.scatteredFeatureSizeX - 1 - i, i, this.scatteredFeatureSizeZ - 1 - i, Blocks.red_sandstone.getDefaultState(), Blocks.red_sandstone.getDefaultState(), false);
                ...
                for (i = 0; i < this.scatteredFeatureSizeX; ++i)
                {
                    ...
                    {
                        byte b0 = -5;
                        this.func_175808_b(worldIn, Blocks.red_sandstone.getDefaultState(), i, b0, j, p_74875_3_);
                    }
                }

                i = this.getMetadataWithOffset(Blocks.red_sandstone_stairs, 3);
                j = this.getMetadataWithOffset(Blocks.red_sandstone_stairs, 2);
                int i2 = this.getMetadataWithOffset(Blocks.red_sandstone_stairs, 0);
                int k = this.getMetadataWithOffset(Blocks.red_sandstone_stairs, 1);
                int l = ~EnumDyeColor.ORANGE.getDyeDamage() & 15;
                int i1 = ~EnumDyeColor.BLUE.getDyeDamage() & 15;
                this.func_175804_a(worldIn, p_74875_3_, 0, 0, 0, 4, 9, 4, Blocks.red_sandstone.getDefaultState(), Blocks.air.getDefaultState(), false);
                this.func_175804_a(worldIn, p_74875_3_, 1, 10, 1, 3, 10, 3, Blocks.red_sandstone.getDefaultState(), Blocks.red_sandstone.getDefaultState(), false);
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getStateFromMeta(i), 2, 10, 0, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getStateFromMeta(j), 2, 10, 4, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getStateFromMeta(i2), 0, 10, 2, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getStateFromMeta(k), 4, 10, 2, p_74875_3_);
                this.func_175804_a(worldIn, p_74875_3_, this.scatteredFeatureSizeX - 5, 0, 0, this.scatteredFeatureSizeX - 1, 9, 4, Blocks.red_sandstone.getDefaultState(), Blocks.air.getDefaultState(), false);
                this.func_175804_a(worldIn, p_74875_3_, this.scatteredFeatureSizeX - 4, 10, 1, this.scatteredFeatureSizeX - 2, 10, 3, Blocks.red_sandstone.getDefaultState(), Blocks.red_sandstone.getDefaultState(), false);
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getStateFromMeta(i), this.scatteredFeatureSizeX - 3, 10, 0, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getStateFromMeta(j), this.scatteredFeatureSizeX - 3, 10, 4, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getStateFromMeta(i2), this.scatteredFeatureSizeX - 5, 10, 2, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getStateFromMeta(k), this.scatteredFeatureSizeX - 1, 10, 2, p_74875_3_);
                this.func_175804_a(worldIn, p_74875_3_, 8, 0, 0, 12, 4, 4, Blocks.red_sandstone.getDefaultState(), Blocks.air.getDefaultState(), false);
                this.func_175804_a(worldIn, p_74875_3_, 9, 1, 0, 11, 3, 4, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), 9, 1, 1, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), 9, 2, 1, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), 9, 3, 1, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), 10, 3, 1, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), 11, 3, 1, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), 11, 2, 1, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), 11, 1, 1, p_74875_3_);
                this.func_175804_a(worldIn, p_74875_3_, 4, 1, 1, 8, 3, 3, Blocks.red_sandstone.getDefaultState(), Blocks.air.getDefaultState(), false);
                this.func_175804_a(worldIn, p_74875_3_, 4, 1, 2, 8, 2, 2, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
                this.func_175804_a(worldIn, p_74875_3_, 12, 1, 1, 16, 3, 3, Blocks.red_sandstone.getDefaultState(), Blocks.air.getDefaultState(), false);
                this.func_175804_a(worldIn, p_74875_3_, 12, 1, 2, 16, 2, 2, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
                this.func_175804_a(worldIn, p_74875_3_, 5, 4, 5, this.scatteredFeatureSizeX - 6, 4, this.scatteredFeatureSizeZ - 6, Blocks.red_sandstone.getDefaultState(), Blocks.red_sandstone.getDefaultState(), false);
                this.func_175804_a(worldIn, p_74875_3_, 9, 4, 9, 11, 4, 11, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
                this.func_175804_a(worldIn, p_74875_3_, 8, 1, 8, 8, 3, 8, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), false);
                this.func_175804_a(worldIn, p_74875_3_, 12, 1, 8, 12, 3, 8, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), false);
                this.func_175804_a(worldIn, p_74875_3_, 8, 1, 12, 8, 3, 12, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), false);
                this.func_175804_a(worldIn, p_74875_3_, 12, 1, 12, 12, 3, 12, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), false);
                this.func_175804_a(worldIn, p_74875_3_, 1, 1, 5, 4, 4, 11, Blocks.red_sandstone.getDefaultState(), Blocks.red_sandstone.getDefaultState(), false);
                this.func_175804_a(worldIn, p_74875_3_, this.scatteredFeatureSizeX - 5, 1, 5, this.scatteredFeatureSizeX - 2, 4, 11, Blocks.red_sandstone.getDefaultState(), Blocks.red_sandstone.getDefaultState(), false);
                this.func_175804_a(worldIn, p_74875_3_, 6, 7, 9, 6, 7, 11, Blocks.red_sandstone.getDefaultState(), Blocks.red_sandstone.getDefaultState(), false);
                this.func_175804_a(worldIn, p_74875_3_, this.scatteredFeatureSizeX - 7, 7, 9, this.scatteredFeatureSizeX - 7, 7, 11, Blocks.red_sandstone.getDefaultState(), Blocks.red_sandstone.getDefaultState(), false);
                this.func_175804_a(worldIn, p_74875_3_, 5, 5, 9, 5, 7, 11, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), false);
                this.func_175804_a(worldIn, p_74875_3_, this.scatteredFeatureSizeX - 6, 5, 9, this.scatteredFeatureSizeX - 6, 7, 11, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), false);
                ...
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getStateFromMeta(i), 2, 4, 5, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getStateFromMeta(i), 2, 3, 4, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getStateFromMeta(i), this.scatteredFeatureSizeX - 3, 4, 5, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getStateFromMeta(i), this.scatteredFeatureSizeX - 3, 3, 4, p_74875_3_);
                this.func_175804_a(worldIn, p_74875_3_, 1, 1, 3, 2, 2, 3, Blocks.red_sandstone.getDefaultState(), Blocks.red_sandstone.getDefaultState(), false);
                this.func_175804_a(worldIn, p_74875_3_, this.scatteredFeatureSizeX - 3, 1, 3, this.scatteredFeatureSizeX - 2, 2, 3, Blocks.red_sandstone.getDefaultState(), Blocks.red_sandstone.getDefaultState(), false);
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getDefaultState(), 1, 1, 2, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getDefaultState(), this.scatteredFeatureSizeX - 2, 1, 2, p_74875_3_);
                ...
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getStateFromMeta(k), 2, 1, 2, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone_stairs.getStateFromMeta(i2), this.scatteredFeatureSizeX - 3, 1, 2, p_74875_3_);
                this.func_175804_a(worldIn, p_74875_3_, 4, 3, 5, 4, 3, 18, Blocks.red_sandstone.getDefaultState(), Blocks.red_sandstone.getDefaultState(), false);
                this.func_175804_a(worldIn, p_74875_3_, this.scatteredFeatureSizeX - 5, 3, 5, this.scatteredFeatureSizeX - 5, 3, 17, Blocks.red_sandstone.getDefaultState(), Blocks.red_sandstone.getDefaultState(), false);
                ...
                for (j1 = 5; j1 <= 17; j1 += 2)
                {
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), 4, 1, j1, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), 4, 2, j1, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), this.scatteredFeatureSizeX - 5, 1, j1, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), this.scatteredFeatureSizeX - 5, 2, j1, p_74875_3_);
                }
                ...
                {
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1, 2, 1, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(l), j1, 2, 2, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1, 2, 3, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1, 3, 1, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(l), j1, 3, 2, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1, 3, 3, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(l), j1, 4, 1, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), j1, 4, 2, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(l), j1, 4, 3, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1, 5, 1, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(l), j1, 5, 2, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1, 5, 3, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(l), j1, 6, 1, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), j1, 6, 2, p_74875_3_);
                    ...
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1, 8, 1, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1, 8, 2, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1, 8, 3, p_74875_3_);
                }

                for (j1 = 2; j1 <= this.scatteredFeatureSizeX - 3; j1 += this.scatteredFeatureSizeX - 3 - 2)
                {
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1 - 1, 2, 0, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(l), j1, 2, 0, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1 + 1, 2, 0, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1 - 1, 3, 0, p_74875_3_);
                    ...
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), j1, 4, 0, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(l), j1 + 1, 4, 0, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1 - 1, 5, 0, p_74875_3_);
                    ...
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), j1, 6, 0, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(l), j1 + 1, 6, 0, p_74875_3_);
                    ...
                    this.func_175811_a(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(l), j1 + 1, 7, 0, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1 - 1, 8, 0, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1, 8, 0, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), j1 + 1, 8, 0, p_74875_3_);
                }

                this.func_175804_a(worldIn, p_74875_3_, 8, 4, 0, 12, 6, 0, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), false);
                ...
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), 10, 5, 0, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(l), 11, 5, 0, p_74875_3_);
                this.func_175804_a(worldIn, p_74875_3_, 8, -14, 8, 12, -11, 12, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), false);
                this.func_175804_a(worldIn, p_74875_3_, 8, -10, 8, 12, -10, 12, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), false);
                this.func_175804_a(worldIn, p_74875_3_, 8, -9, 8, 12, -9, 12, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), false);
                this.func_175804_a(worldIn, p_74875_3_, 8, -8, 8, 12, -1, 12, Blocks.red_sandstone.getDefaultState(), Blocks.red_sandstone.getDefaultState(), false);
                ...
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), 7, -10, 10, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), 7, -11, 10, p_74875_3_);
                ...
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), 13, -10, 10, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), 13, -11, 10, p_74875_3_);
                ...
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), 10, -10, 7, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), 10, -11, 7, p_74875_3_);
                ...
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), 10, -10, 13, p_74875_3_);
                this.func_175811_a(worldIn, Blocks.red_sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), 10, -11, 13, p_74875_3_);
    ...
    abstract static class Feature extends StructureComponent
        {
            ...
            protected Feature(Random p_i2065_1_, int p_i2065_2_, int p_i2065_3_, int p_i2065_4_, int p_i2065_5_, int p_i2065_6_, int p_i2065_7_)
            {
                ...
                switch (CustomComponentScatteredFeature.SwitchEnumFacing.field_175956_a[this.coordBaseMode.ordinal()])
                {
                    case 1:
                    case 2:
    ...
    public static class JunglePyramid extends CustomComponentScatteredFeature.Feature
        {
            private boolean field_74947_h;
            private boolean field_74948_i;
            private boolean field_74945_j;
            private boolean field_74946_k;
            private static final List field_175816_i = Lists.newArrayList(new WeightedRandomChestContent[] {new WeightedRandomChestContent(Items.diamond, 0, 1, 3, 3), new WeightedRandomChestContent(Items.iron_ingot, 0, 1, 5, 10), new WeightedRandomChestContent(Items.gold_ingot, 0, 2, 7, 15), new WeightedRandomChestContent(Items.emerald, 0, 1, 3, 2), new WeightedRandomChestContent(ItemManager.lightningOrb, 0, 4, 6, 20), new WeightedRandomChestContent(ItemManager.customItem, 0, 3, 7, 16), new WeightedRandomChestContent(Items.saddle, 0, 1, 1, 3), new WeightedRandomChestContent(Items.iron_horse_armor, 0, 1, 1, 1), new WeightedRandomChestContent(Items.golden_horse_armor, 0, 1, 1, 1), new WeightedRandomChestContent(Items.diamond_horse_armor, 0, 1, 1, 1)});
            private static final List field_175815_j = Lists.newArrayList(new WeightedRandomChestContent[] {new WeightedRandomChestContent(Items.fire_charge, 0, 2, 7, 30)});
            /** List of random stones to be generated in the Jungle Pyramid. */
            private static CustomComponentScatteredFeature.JunglePyramid.Stones junglePyramidsRandomScatteredStones = new CustomComponentScatteredFeature.JunglePyramid.Stones((CustomComponentScatteredFeature.SwitchEnumFacing)null);
            private static final String __OBFID = "CL_00000477";

            static
            {
                ChestGenHooks.init(PYRAMID_JUNGLE_DISPENSER, field_175815_j, 2, 2);
                ChestGenHooks.init(VILLAGE_BLACKSMITH, field_175816_i, 2, 7);
                ChestGenHooks.addItem(NETHER_FORTRESS, new WeightedRandomChestContent(new ItemStack(Items.enchanted_book, 1, 0), 1, 1, 1));
            }
            ...
            public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_)
            {
                ...
                {
                    int i = this.getMetadataWithOffset(Blocks.brick_stairs, 3);
                    int j = this.getMetadataWithOffset(Blocks.brick_stairs, 2);
                    int k = this.getMetadataWithOffset(Blocks.brick_stairs, 0);
                    int l = this.getMetadataWithOffset(Blocks.brick_stairs, 1);
                    ...
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(i), 5, 9, 6, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(i), 6, 9, 6, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(j), 5, 9, 8, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(j), 6, 9, 8, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(i), 4, 0, 0, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(i), 5, 0, 0, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(i), 6, 0, 0, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(i), 7, 0, 0, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(i), 4, 1, 8, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(i), 4, 2, 9, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(i), 4, 3, 10, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(i), 7, 1, 8, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(i), 7, 2, 9, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(i), 7, 3, 10, p_74875_3_);
                    ...
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(k), 4, 4, 5, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(l), 7, 4, 5, p_74875_3_);

                    for (i1 = 0; i1 < 4; ++i1)
                    {
                        this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(j), 5, 0 - i1, 6 + i1, p_74875_3_);
                        this.func_175811_a(worldIn, Blocks.brick_stairs.getStateFromMeta(j), 6, 0 - i1, 6 + i1, p_74875_3_);
                    ...
                    this.func_175811_a(worldIn, Blocks.end_stone.getDefaultState(), 3, -3, 1, p_74875_3_);
                    ...
                    this.func_175811_a(worldIn, Blocks.end_stone.getDefaultState(), 9, -3, 4, p_74875_3_);
                    ...
                    this.func_175811_a(worldIn, Blocks.end_stone.getDefaultState(), 9, -3, 2, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.end_stone.getDefaultState(), 8, -3, 1, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.end_stone.getDefaultState(), 4, -3, 5, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.end_stone.getDefaultState(), 5, -2, 5, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.end_stone.getDefaultState(), 5, -1, 5, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.end_stone.getDefaultState(), 6, -3, 5, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.end_stone.getDefaultState(), 7, -2, 5, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.end_stone.getDefaultState(), 7, -1, 5, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.end_stone.getDefaultState(), 8, -3, 5, p_74875_3_);
                    ...
                    this.func_175811_a(worldIn, Blocks.sand.getStateFromMeta(0), 8, -2, 11, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.sand.getStateFromMeta(1), 9, -2, 11, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.sand.getStateFromMeta(0), 10, -2, 11, p_74875_3_);
                    ...
                    this.func_175811_a(worldIn, Blocks.end_stone.getDefaultState(), 10, -2, 9, p_74875_3_);
            ...
            static class Stones extends StructureComponent.BlockSelector
                {
                    ...
                    public void selectBlocks(Random p_75062_1_, int p_75062_2_, int p_75062_3_, int p_75062_4_, boolean p_75062_5_)
                    {
                        ...
                        {
                            this.field_151562_a = Blocks.end_stone.getDefaultState();
                        }
                        else
                        {
                            this.field_151562_a = Blocks.netherrack.getDefaultState();
                        }
                    }

                    Stones(CustomComponentScatteredFeature.SwitchEnumFacing p_i45583_1_)
                    {
                        this();
                    }
                }
    ...
    public static class SwampHut extends CustomComponentScatteredFeature.Feature
        {
            ...
            public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_)
            {
                ...
                {
                    this.func_175804_a(worldIn, p_74875_3_, 1, 1, 1, 5, 1, 7, Blocks.planks.getStateFromMeta(BlockPlanks.EnumType.JUNGLE.getMetadata()), Blocks.planks.getStateFromMeta(BlockPlanks.EnumType.JUNGLE.getMetadata()), false);
                    this.func_175804_a(worldIn, p_74875_3_, 1, 4, 2, 5, 4, 7, Blocks.planks.getStateFromMeta(BlockPlanks.EnumType.JUNGLE.getMetadata()), Blocks.planks.getStateFromMeta(BlockPlanks.EnumType.JUNGLE.getMetadata()), false);
                    this.func_175804_a(worldIn, p_74875_3_, 2, 1, 0, 4, 1, 0, Blocks.planks.getStateFromMeta(BlockPlanks.EnumType.JUNGLE.getMetadata()), Blocks.planks.getStateFromMeta(BlockPlanks.EnumType.JUNGLE.getMetadata()), false);
                    this.func_175804_a(worldIn, p_74875_3_, 2, 2, 2, 3, 3, 2, Blocks.planks.getStateFromMeta(BlockPlanks.EnumType.JUNGLE.getMetadata()), Blocks.planks.getStateFromMeta(BlockPlanks.EnumType.JUNGLE.getMetadata()), false);
                    this.func_175804_a(worldIn, p_74875_3_, 1, 2, 3, 1, 3, 6, Blocks.planks.getStateFromMeta(BlockPlanks.EnumType.JUNGLE.getMetadata()), Blocks.planks.getStateFromMeta(BlockPlanks.EnumType.JUNGLE.getMetadata()), false);
                    this.func_175804_a(worldIn, p_74875_3_, 5, 2, 3, 5, 3, 6, Blocks.planks.getStateFromMeta(BlockPlanks.EnumType.JUNGLE.getMetadata()), Blocks.planks.getStateFromMeta(BlockPlanks.EnumType.JUNGLE.getMetadata()), false);
                    this.func_175804_a(worldIn, p_74875_3_, 2, 2, 7, 4, 3, 7, Blocks.planks.getStateFromMeta(BlockPlanks.EnumType.JUNGLE.getMetadata()), Blocks.planks.getStateFromMeta(BlockPlanks.EnumType.JUNGLE.getMetadata()), false);
                    this.func_175804_a(worldIn, p_74875_3_, 1, 0, 2, 1, 3, 2, Blocks.log.getStateFromMeta(2), Blocks.log.getStateFromMeta(2), false);
                    this.func_175804_a(worldIn, p_74875_3_, 5, 0, 2, 5, 3, 2, Blocks.log.getStateFromMeta(2), Blocks.log.getStateFromMeta(2), false);
                    this.func_175804_a(worldIn, p_74875_3_, 1, 0, 7, 1, 3, 7, Blocks.log.getStateFromMeta(2), Blocks.log.getStateFromMeta(2), false);
                    this.func_175804_a(worldIn, p_74875_3_, 5, 0, 7, 5, 3, 7, Blocks.log.getStateFromMeta(2), Blocks.log.getStateFromMeta(2), false);
                    this.func_175811_a(worldIn, Blocks.jungle_fence.getDefaultState(), 2, 3, 2, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.jungle_fence.getDefaultState(), 3, 3, 7, p_74875_3_);
                    ...
                    this.func_175811_a(worldIn, Blocks.flower_pot.getDefaultState().withProperty(BlockFlowerPot.CONTENTS, BlockFlowerPot.EnumFlowerType.HOUSTONIA), 1, 3, 5, p_74875_3_);
                    ...
                    this.func_175811_a(worldIn, Blocks.jungle_fence.getDefaultState(), 1, 2, 1, p_74875_3_);
                    this.func_175811_a(worldIn, Blocks.jungle_fence.getDefaultState(), 5, 2, 1, p_74875_3_);
                    int i = this.getMetadataWithOffset(Blocks.birch_stairs, 3);
                    int j = this.getMetadataWithOffset(Blocks.birch_stairs, 1);
                    int k = this.getMetadataWithOffset(Blocks.birch_stairs, 0);
                    int l = this.getMetadataWithOffset(Blocks.birch_stairs, 2);
                    this.func_175804_a(worldIn, p_74875_3_, 0, 4, 1, 6, 4, 1, Blocks.acacia_stairs.getStateFromMeta(i), Blocks.acacia_stairs.getStateFromMeta(i), false);
                    this.func_175804_a(worldIn, p_74875_3_, 0, 4, 2, 0, 4, 7, Blocks.acacia_stairs.getStateFromMeta(k), Blocks.acacia_stairs.getStateFromMeta(k), false);
                    this.func_175804_a(worldIn, p_74875_3_, 6, 4, 2, 6, 4, 7, Blocks.acacia_stairs.getStateFromMeta(j), Blocks.acacia_stairs.getStateFromMeta(j), false);
                    this.func_175804_a(worldIn, p_74875_3_, 0, 4, 8, 6, 4, 8, Blocks.acacia_stairs.getStateFromMeta(l), Blocks.acacia_stairs.getStateFromMeta(l), false);
                    int i1;
                    int j1;
                    ...
                    for (i1 = 2; i1 <= 7; i1 += 5)
                    {
                        for (j1 = 1; j1 <= 5; j1 += 4)
                        {
                            this.func_175808_b(worldIn, Blocks.log.getStateFromMeta(2), j1, -1, i1, p_74875_3_);
                        }
                    }
