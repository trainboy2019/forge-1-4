...
public class TestGenLayerBiome extends GenLayer
{
    ...
    public TestGenLayerBiome(long p_i2122_1_, GenLayer p_i2122_3_, WorldType p_i2122_4_)
    {
        ...
        if (p_i2122_4_ == WorldType.DEFAULT_1_1)
        {
            ...
            biomes[desertIdx].add(new BiomeEntry(BiomeGenBase.jungle, 10));
            ...
            biomes[desertIdx].add(new BiomeEntry(BiomeGenBase.icePlains, 10));
            biomes[desertIdx].add(new BiomeEntry(ModBiomes.firestone, 10));
            biomes[desertIdx].add(new BiomeEntry(ModBiomes.desertTest, 10));
            biomes[desertIdx].add(new BiomeEntry(cm.customBiome, 10));
        }
        else
        {
