...
public class CatCow extends EntityTameable
{
    ...
    public CatCow(World worldIn)
    {
       ...
       // this.tasks.addTask(2, this.aiSit);
        this.tasks.addTask(3, this.aiTempt = new EntityAITempt(this, 0.6D, Items.brick, true));
       ...
       // this.tasks.addTask(6, new EntityAIOcelotSit(this, 0.8D));
        ...
        this.targetTasks.addTask(1, new EntityAITargetNonTamed(this, EntityOcelot.class, false, (Predicate)null));
    }
    ...
    public boolean interact(EntityPlayer player)
    {
        ...
        else if (this.aiTempt.isRunning() && itemstack != null && itemstack.getItem() == Items.brick && player.getDistanceSqToEntity(this) < 9.0D)
        {
    ...
    public CatCow func_180493_b(EntityAgeable p_180493_1_)
    {
        CatCow entityocelot = new CatCow(this.worldObj);
    ...
    {
        return stack != null && stack.getItem() == Items.brick;
    }
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof CatCow))
        {
            return false;
        }
        else
        {
            CatCow entityocelot = (CatCow)otherAnimal;
