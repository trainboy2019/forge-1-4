...
public class CustomContainerChest extends Container
{
    private IInventory lowerChestInventory;
    private int numRows;
    private static final String __OBFID = "CL_00001742";

    public CustomContainerChest(IInventory playerInventory, IInventory chestInventory, EntityPlayer player)
    {
    	int slots = chestInventory.getSizeInventory();
    	slots = 45;
    	chestInventory.equals(slots);
    ...
    public int setSizeInventory(int slots){
    	return slots;
    }
