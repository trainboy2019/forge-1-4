...
public class CustomInventoryLargeChest implements ILockableContainer
{
    /** Name of the chest. */
    private String name;
    ...
    public CustomInventoryLargeChest(String p_i45905_1_, ILockableContainer p_i45905_2_, ILockableContainer p_i45905_3_)
    {
