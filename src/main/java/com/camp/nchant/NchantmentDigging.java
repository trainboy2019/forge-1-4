...
public class NchantmentDigging extends Enchantment
{
    public static final String __OBFID = "CL_00000104";

    public NchantmentDigging(int enchID, ResourceLocation enchName, int enchWeight)
    {
